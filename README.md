...
# 1) Load dataset
df = pd.read_csv('/content/exp_2_dataset_student_scores (1).csv')   # CSV should have two columns, e.g. "Hours","Scores"
print("First 5 rows:\n", df.head(), "\n")
print("Last 5 rows:\n", df.tail(), "\n")
...
print("\nTraining samples:", len(X_train), " Testing sample:",len(X_test))
...
<img width="1117" height="701" alt="Screenshot 2026-07-25 114027" src="https://github.com/user-attachments/assets/3c6f6b9b-9bd1-4fb5-a10b-45179f83dc62" />
<img width="1027" height="722" alt="Screenshot 2026-07-25 113853" src="https://github.com/user-attachments/assets/e1f17bbb-8670-4902-bf41-14207b4b0cdc" />
<img width="942" height="826" alt="Screenshot 2026-07-25 113910" src="https://github.com/user-attachments/assets/fbb533f6-ede9-4682-a87b-a5fc44fa23df" />
